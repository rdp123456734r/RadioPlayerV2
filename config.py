...
class Config:
    ...
    CHAT = int(os.environ.get("CHAT", "jrf"))
    LOG_GROUP = os.environ.get("LOG_GROUP", "fjjf")
    if LOG_GROUP:
        LOG_GROUP = int(LOG_GROUP)
    else:
        LOG_GROUP = None
    STREAM_URL = os.environ.get("STREAM_URL", "https://radioindia.net/radio/hungamanow/icecast.audio")
    API_HASH = os.environ.get("API_HASH", "nfn")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "hhd") 
    SESSION = os.environ.get("SESSION_STRING", "jdj")
